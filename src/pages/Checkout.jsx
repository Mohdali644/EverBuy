...
export default function Checkout() {
  ...
  return (
    ...
    <div className="min-h-screen pt-[170px] sm:pt-[130px] md:pt-[110px] bg-[#f8fafc] bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-orange-100/40 via-slate-50 to-slate-100 font-sans pb-16 selection:bg-[#ff9900] selection:text-white">
      ...
      <header className="bg-[#0f172a] py-4 sm:py-5 text-center border-b-[4px] border-[#ff9900] relative px-4 sm:px-6 shadow-xl z-10 bg-[url('https://www.transparenttextures.com/patterns/stardust.png')] flex items-center justify-center min-h-[60px] sm:min-h-[76px]">
        ...
        <div className="inline-flex justify-center items-center gap-1.5 sm:gap-2.5 text-white text-[1.1rem] sm:text-[1.35rem] md:text-[1.75rem] font-black tracking-tight drop-shadow-lg ml-10 sm:ml-0">
      ...
      <main className="max-w-[1200px] mx-auto mt-6 md:mt-10 px-3 sm:px-4 md:px-8 grid grid-cols-1 lg:grid-cols-[1.5fr_1fr] gap-6 md:gap-8 relative z-20">
        ...
        <div className="flex flex-col gap-6 md:gap-8">
          ...
          <div className="bg-white/90 backdrop-blur-xl p-5 sm:p-6 md:p-7 rounded-[24px] md:rounded-[28px] shadow-[0_10px_40px_rgba(0,0,0,0.03)] border border-slate-100">
            <h2 className="text-[0.7rem] sm:text-[0.75rem] font-black text-slate-400 uppercase tracking-[0.2em] mb-4 sm:mb-5 text-center">Express Checkout</h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
              <button className="flex justify-center items-center gap-2 w-full bg-[#000] hover:bg-slate-800 text-white py-3.5 px-4 rounded-xl sm:rounded-2xl text-sm sm:text-base font-semibold transition-all hover:shadow-[0_8px_20px_rgba(0,0,0,0.15)] hover:-translate-y-0.5">
                <i className="fa-brands fa-apple text-lg sm:text-xl mb-[2px]"></i> Pay
              </button>
              <button className="flex justify-center items-center gap-2 w-full bg-white hover:bg-gray-50 text-slate-700 border-2 border-slate-100 py-3.5 px-4 rounded-xl sm:rounded-2xl text-sm sm:text-base font-semibold transition-all hover:shadow-[0_8px_20px_rgba(0,0,0,0.05)] hover:-translate-y-0.5">
            ...
            <div className="relative flex items-center justify-center mt-5 sm:mt-6 mb-1 sm:mb-2">
              ...
              <span className="relative bg-white px-4 text-[0.65rem] sm:text-[0.7rem] font-bold text-slate-400 uppercase tracking-widest rounded-full">Or pay with card</span>
            </div>
          </div>
          ...
          <form className="bg-white/90 backdrop-blur-xl p-5 sm:p-6 md:p-8 rounded-[24px] md:rounded-[28px] shadow-[0_10px_40px_rgba(0,0,0,0.03)] border border-slate-100 flex flex-col gap-8 md:gap-10">
            ...
            <div>
              <div className="flex items-center gap-3 md:gap-3.5 mb-5 md:mb-6">
                <div className="w-7 h-7 md:w-8 md:h-8 rounded-lg md:rounded-xl bg-gradient-to-br from-slate-800 to-slate-900 text-white flex items-center justify-center font-black text-sm md:text-base shadow-md shrink-0">1</div>
                <h2 className="text-lg md:text-xl font-black text-slate-900 tracking-tight">Shipping Details</h2>
              </div>
            ...
            <div>
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-4 mb-5 md:mb-6">
                <div className="flex items-center gap-3 md:gap-3.5">
                  <div className="w-7 h-7 md:w-8 md:h-8 rounded-lg md:rounded-xl bg-gradient-to-br from-slate-800 to-slate-900 text-white flex items-center justify-center font-black text-sm md:text-base shadow-md shrink-0">2</div>
                  <h2 className="text-lg md:text-xl font-black text-slate-900 tracking-tight">Payment Method</h2>
                </div>
                
                <div className="flex gap-2 sm:gap-2.5">
                  <div className="bg-white border-2 border-[#1a1f71]/10 px-2.5 py-1 rounded-lg sm:rounded-xl shadow-sm flex items-center justify-center">
                    <i className="fa-brands fa-cc-visa text-xl sm:text-2xl text-[#1a1f71]"></i>
                  </div>
                  <div className="bg-white border-2 border-[#eb001b]/10 px-2.5 py-1 rounded-lg sm:rounded-xl shadow-sm flex items-center justify-center">
                    <i className="fa-brands fa-cc-mastercard text-xl sm:text-2xl text-[#eb001b]"></i>
                  </div>
                  <div className="bg-white border-2 border-[#2e77bc]/10 px-2.5 py-1 rounded-lg sm:rounded-xl shadow-sm flex items-center justify-center">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                ...
                <div className="grid grid-cols-2 gap-3 sm:gap-4">
                  <div className="relative group">
                    <i className="fa-regular fa-calendar absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 text-base group-focus-within:text-[#ff9900] transition-colors hidden sm:block"></i>
                  ...
                  <div className="relative group">
                    <i className="fa-solid fa-lock absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 text-base group-focus-within:text-[#ff9900] transition-colors hidden sm:block"></i>
        ...
        <div className="relative">
          <div className="bg-white/95 backdrop-blur-2xl p-5 sm:p-6 md:p-7 rounded-[24px] md:rounded-[28px] shadow-[0_12px_45px_rgba(0,0,0,0.05)] border border-slate-100 lg:sticky lg:top-[140px]">
            ...
            <h2 className="text-lg md:text-xl font-black text-slate-900 mb-4 md:mb-5 tracking-tight">Order Summary</h2>
            ...
            <div className="flex gap-2 mb-5 md:mb-6 border-b-2 border-slate-100 pb-5 md:pb-6">
              <div className="relative flex-grow">
                <i className="fa-solid fa-tag absolute left-3 top-1/2 -translate-y-1/2 text-slate-400 text-sm md:text-base"></i>
                <input type="text" placeholder="Promo Code" className="w-full bg-slate-50 border-2 border-slate-100 rounded-xl py-2 md:py-2.5 px-3 pl-8 md:pl-9 text-[16px] md:text-base font-bold outline-none focus:border-[#ff9900] focus:bg-white transition-all uppercase placeholder:normal-case placeholder:font-medium placeholder:text-slate-400" />
              </div>
              <button className="bg-slate-900 hover:bg-slate-800 text-white px-4 md:px-5 py-2 md:py-2.5 rounded-xl text-xs md:text-sm font-bold transition-colors shadow-md">Apply</button>
            </div>
            ...
            <div className="flex flex-col gap-2.5 md:gap-3.5 text-slate-500 font-semibold mb-5 md:mb-6 text-sm md:text-base">
              ...
              <div className="flex justify-between items-center">
                <span>Shipping</span>
                <span className="text-[#10b981] font-black bg-[#10b981]/10 px-2 py-0.5 rounded-md text-xs md:text-sm">FREE Prime</span>
              </div>
              <div className="flex justify-between">
                <span>Taxes</span>
            ...
            <button
              ...
              className={`w-full py-3.5 md:py-4 rounded-xl md:rounded-2xl font-black tracking-wider text-base md:text-lg transition-all flex items-center justify-center gap-2 md:gap-3 shadow-lg ${
            ...
            {/* Trust Badges */}
            <div className="mt-5 md:mt-6 flex flex-col items-center gap-2 text-[0.65rem] md:text-[0.7rem] font-bold text-slate-400">
              <div className="flex items-center gap-1.5 md:gap-2 bg-emerald-50 text-emerald-600 px-3 py-1 md:py-1.5 rounded-full border border-emerald-100">
                <i className="fa-solid fa-shield-check text-emerald-500 text-xs md:text-sm"></i> Secured with AES-256 Bit Encryption
              </div>
              <p className="text-center px-1 md:px-3 leading-relaxed">Your payment information is tokenized and processed securely. EverBuy never stores your raw card data.</p>
            </div>
