        ...
        <div className="w-full overflow-hidden no-scrollbar relative z-10">
          ...
          <div className="animate-infinite-scroll gap-6 px-3">
            {[
              ...
              { id: 5, name: "Anil.", role: "University Student", img: "https://i.pravatar.cc/150?u=5", review: "Customer service handled my return in under 5 minutes. No endless automated bots, just instant, helpful support. Lifetime customer right here." },
              { id: 6, name: "Arjun D.", role: "Digital Marketer", img: "https://i.pravatar.cc/150?u=6", review: "Managed to snag a massive flash deal on noise-cancelling headphones. The live tracking and inventory updates are highly accurate." },
