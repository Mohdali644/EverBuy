    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              ...
              <div className="flex items-center gap-1.5">
                <i className="fa-solid fa-location-dot mb-1 text-green-500 text-[1.10rem]"></i>
          ...
          <div
            className={`transition-all py-1 duration-500 sm:overflow-x-hidden overflow-x-scroll overflow-y-hidden scrollbar-hide flex-nowrap whitespace-nowrap flex items-center px-4 sm:px-6 gap-6 text-[0.8rem] sm:text-[0.85rem] font-medium max-w-[1800px] mx-auto tracking-wide overscroll-x-contain touch-pan-x ${isScrolled ? "h-0 opacity-0 border-transparent" : "h-[35px] sm:h-[40px] opacity-100 border-t border-white/10"}`}
          >
            <button
              className="group flex items-center gap-1.5 px-3 py-1 rounded-full shrink-0 text-[14px] text-white bg-white/10 hover:bg-gray-100 hover:text-black transition-all outline-none focus:outline-none"
            ...
            <button
              ...
              className="px-3 py-1 ml-5 mr-6 rounded-full text-slate-100 bg:text-white bg-white/10 hover:bg-gray-100 hover:text-black transition-all outline-none focus:outline-none shrink-0"
            >
              Today's Deals
            </button>
            <button
